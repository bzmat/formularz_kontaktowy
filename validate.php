...
session_start();
	...
	if (isset($name) && ($val_email == TRUE) && isset($contents)) {
		     ...
		     require_once('class.smtp.php');    //dodanie klasy smtp
			    ...
			    $mail->Username = "mateusz.bzdzion";    //nazwa użytkownika do skrzynki e-mail
			    $mail->Password = "Terenia1985";    //hasło użytkownika do skrzynki e-mail
			    ...
			    $mail->AddAddress ("mateusz.bzdzion@gmail.com","Mateusz");    //adres skrzynki e-mail oraz nazwa
